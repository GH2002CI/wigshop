...
<body>
        ...
        <div class="row bg-secondary py-1 px-xl-5">
            ...
            <div class="col-lg-6 text-center text-lg-right">
                ...
                <div class="d-inline-flex align-items-center d-block d-lg-none">
                    ...
                    if (isset($_SESSION['idUser']) && $_SESSION['idUser'] == true) {
                        echo '
                        <a href="favorite.php" class="btn px-0 ml-2">
                        <i class="fas fa-heart text-dark"></i>
                            <span class="badge text-dark border border-dark rounded-circle" style="padding-bottom: 2px;">' . mysqli_num_rows($getdata->se_favorite($_SESSION['idUser'])) . '</span>
                        </a>
                        <a href="cart.php" class="btn px-0 ml-2">
                            <i class="fas fa-shopping-cart text-dark"></i>
                            <span class="badge text-dark border border-dark rounded-circle" style="padding-bottom: 2px;">' . mysqli_num_rows($getdata->se_cart($_SESSION['idUser'])) . '</span>
                        </a>
                        ';
                    } else {
                        echo '
                    ...
                    <div class="navbar-nav w-100">
                        ...
                        foreach ($seCategory as $category) {
                            ...
                            <a href="category.php?category=<?php echo $category['category'] ?>"
                                class="nav-item nav-link"><?php echo $category['category'] ?></a>
                        <?php } ?>
                    </div>
                </nav>
            </div>
    ...
    <div class="container-fluid pt-5 pb-3">
        ...
        <div class="row px-xl-5">
            ...
            $total_page = ceil(mysqli_num_rows($getdata->se_product_category($_GET['category'])) / 16);
            $product_start = (($page - 1) * 16);
            $selectRecent = $getdata->se_recent_category($_GET['category'], $product_start);
                        ...
                        <div class="product-img position-relative overflow-hidden">
                            ...
                            <div class="product-action">
                                <a class="btn btn-outline-dark btn-square"
                                    href="detail.php?idProduct=<?php echo $recent['id'] ?>"><i
